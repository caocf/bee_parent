...
<div class="main inner">
    ...
    <div class="row query-inner">
        <a href="${basePath}/admin/shop/${sid}/group/new" class="btn btn-primary icon-text" alt="增加商家组">
    ...
    <table class="table table-hover">
        ...
        <c:forEach items="${result}" var="group">
            <tr>
                ...
                <td>${group.remark}</td>
                <td>
                    <a href="${basePath}/admin/shop/${sid}/group/${group.sgId}/edit" class="icon" role="button">
