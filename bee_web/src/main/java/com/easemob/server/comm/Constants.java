...
public interface Constants {
	...
	// APPKEY
	public static String APPKEY = "qsd#beetest";
	// APP_CLIENT_ID
	public static String APP_CLIENT_ID = "YXA6L41z0OXdEeS7Yg3JmtiMIA";
	// APP_CLIENT_SECRET
	public static String APP_CLIENT_SECRET = "YXA6QYbEjnfuDpHKyHsemkGdEWiM15Y";
    // ORG_ADMIN_USERNAME
