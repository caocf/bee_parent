...
<head>
  ...
  <body>
      ...
      <div id="EChart" class="row" style="height:350px;">
      </div>

        <div id="loginStat24h" class="row" style="height: 350px">
    ...
    <script type="text/javascript">
      ...
      $.get(BasePath + "/stat/user/chart", function(data) {
        ...
        require(
                ...
                function (ec) {
                    // 基于准备好的dom，初始化echarts图表
                    dChart = ec.init(document.getElementById('loginStat24h'));
        ...
        function showLoginDetail(name) {
            $.get(BasePath + "/stat/user/detail?name="+name, function(data) {
                dChart.clear();
