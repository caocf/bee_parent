...
<div class="main inner">
    ...
    <div class="row query-inner">
        <sec:security auth="<%=AuthName.ShopUserNew%>">
        <a href="${basePath}/shop/${sid}/admin/new" class="btn btn-primary icon-text" alt="增加管理员">
    ...
    <table class="table table-hover">
        ...
        <c:forEach items="${result}" var="admins">
            <tr>
                ...
                <td>
                    <sec:security auth="<%=AuthName.ShopUserDelete%>">
...
<script type="text/javascript">
    ...
    function deleteImage(id) {
        document.forms['delForm'].action = "${basePath}/shop/${sid}/admin/" + id;
